...
<body class="bg-gray-100 h-screen flex items-center justify-center">
    <div class="max-w-md mx-auto bg-white p-8 shadow-lg rounded-lg">
        ...
        <c:if test="${not empty sessionScope.admin}">
            <h1 class="text-3xl font-bold mb-4 text-center">Close Customer Account</h1>
            <form action="CloseCustomerServlet" method="post" class="space-y-4">
                ...
                <div class="flex justify-center">
                    <input type="submit" value="Close Account" class="bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded-lg cursor-pointer">
                </div>
            </form>
        </c:if>
    </div>
